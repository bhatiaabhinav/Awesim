...
bool HW_RENDERING_ENABLED = true;       // Hardware rendering enabled by default
...
bool DRAW_LANE_IDS = false;             // Draw lane IDs
bool DRAW_CAR_SPEEDS = true;           // Draw car speeds
bool DRAW_ROAD_NAMES = false;           // Draw road names
...
SDL_Color HIGHLIGHTED_NEARBY_VEHICLES_COLOR = CAR_COLOR; // Use same color as normal cars (olive greenish) to disable special highlighting
