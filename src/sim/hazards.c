...
//         LOG_ERROR("One or both lanes are NULL");
//         return (TrackIntersectionPoint){NULL, NULL, 0, 0, false};
//     } else if (lane1->type == LINEAR_LANE && lane2->type == LINEAR_LANE) {
//         return track_intersection_check_linear_linear((const LinearLane*)lane1, (const LinearLane*)lane2);
//     } else if (lane1->type == LINEAR_LANE && lane2->type == QUARTER_ARC_LANE) {
//         return track_intersection_check_linear_curved((const LinearLane*)lane1, (const QuarterArcLane*)lane2);
//     } else if (lane1->type == QUARTER_ARC_LANE && lane2->type == LINEAR_LANE) {
//         return track_intersection_check_linear_curved((const LinearLane*)lane2, (const QuarterArcLane*)lane1);
//     } else if (lane1->type == QUARTER_ARC_LANE && lane2->type == QUARTER_ARC_LANE) {
//         return track_intersection_check_curved_curved((const QuarterArcLane*)lane1, (const QuarterArcLane*)lane2);
//     } else {
//         LOG_ERROR("Unsupported lane types for intersection check");
//         return (TrackIntersectionPoint){NULL, NULL, 0, 0, false};
//     }
// }
