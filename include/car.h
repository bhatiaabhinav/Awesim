...
// utility to    perceive another car with noise based on 'sim' parameters. Returns true if 'other' is perceived, false otherwise. Pass NULL for any output parameter if not needed. If noisy is false, bypasses dropout and noise (perfect perception).
