...
from gymenv_utils import EntropyDecayCallback, POLICY_NET_1024_512_256_RELU_LN_CONFIG
...
FULL_CONFIG = {**CONFIG, **ENV_CONFIG, **VEC_ENV_CONFIG, **PPO_CONFIG, **POLICY_NET_1024_512_256_RELU_LN_CONFIG}
...
def train_model() -> tuple[PPO, Union[VecNormalize, VecEnv]]:
    ...
    model = PPO("MlpPolicy", vec_env, policy_kwargs=POLICY_NET_1024_512_256_RELU_LN_CONFIG, **PPO_CONFIG)
