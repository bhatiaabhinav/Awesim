...
from pyawesim.train_vision import ModelArchitecture
...
from pyawesim.train_vision import ENV_CONFIG
ENV_CONFIG.update({
...
from pyawesim.train_vision import NET_CONFIG
from pyawesim.train_vision import POLICY_CONFIG
